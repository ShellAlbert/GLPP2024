-- =============================================================================
--  VHDL instance generated by IPExpress    09/04/2024    08:30:38         
--  Filename: core_la0_inst.vhd                                          
...
PACKAGE core_la0_pkg IS
    ...
    PORT (
        ...
        trace_din:	IN std_logic_vector (1 downto 0);
        ip_enable:	IN std_logic
    );

    END COMPONENT;

END PACKAGE core_la0_pkg;
